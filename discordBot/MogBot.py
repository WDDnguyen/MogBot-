...
from discordBot.Reddit import RedditController
...
redditController = RedditController.RedditController()

listOfCommands = {'!magic','!weather', '!league','!reddit'}
...
# REDDIT MODE
        ...
        messageComponentList = formatMessage(message).split(' ', 2)
        redditCommand = messageComponentList[0]
        redditSubCommand = messageComponentList[1]
